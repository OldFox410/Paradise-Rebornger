...
changeling-devour-attempt-failed-not-dead = Это тело ещё живо! Мы не можем поглотить его живьём!
...
changeling-transform-bui-drop-identity-menu = Выбросить съеденное существо из памяти.
changeling-transform-bui-drop-identity-entity = Бросить { $entity }
changeling-transform-bui-drop-identity-entity-popup = Вы выбрасываете { $entity } из вашей памяти.
changeling-transform-bui-drop-identity-cannot-drop = Вы не можете выбросить текущую личность.
