...
public sealed class EvacShuttleTest : GameTest
{
    ...
    public async Task EmergencyEvacTest()
    {
        ...
        var saltern = data.Grids.First(x => !entMan.HasComponent<Server._Lavaland.Procedural.Components.LavalandStationComponent>(x)); // Lavaland change - ignore lavaland outpost
