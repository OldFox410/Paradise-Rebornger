...
public sealed class CursedHeartSystem : EntitySystem
{
    ...
    private static readonly ProtoId<DamageGroupPrototype> AirlossDamage = "Airloss";
    private static readonly ProtoId<DamageGroupPrototype> BruteDamage = "Brute";
    private static readonly ProtoId<DamageGroupPrototype> BurnDamage = "Burn";
    private static readonly EntProtoId PumpActionProto = "ActionPumpCursedHeart";
    ...
    private void Damage(EntityUid uid)
    {
        ...
        _damage.TryChangeDamage(uid, new DamageSpecifier(_proto.Index(AirlossDamage), 50), true, false);
    ...
    {
        _actions.AddAction(uid, ref comp.PumpActionEntity, PumpActionProto);
    }
    ...
    private void OnPump(EntityUid uid, CursedHeartComponent comp, PumpHeartActionEvent args)
    {
        ...
        _damage.TryChangeDamage(uid, new DamageSpecifier(_proto.Index(BruteDamage), -5), true, false);
        _damage.TryChangeDamage(uid, new DamageSpecifier(_proto.Index(AirlossDamage), -5), true, false);
        _damage.TryChangeDamage(uid, new DamageSpecifier(_proto.Index(BurnDamage), -8), true, false);
